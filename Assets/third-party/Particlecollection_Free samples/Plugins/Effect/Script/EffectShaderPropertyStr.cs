...
public class EffectShaderPropertyStr
{
    ...
    public static readonly int Material_Color = Shader.PropertyToID(ColorStr);
    public static readonly int Material_Color_Factor = Shader.PropertyToID(ColorFactor);
}