...
namespace Melanchall.DryWetMidi.Standards
{
    internal static class GeneralMidi2Utilities
    {
        ...
        private sealed class GeneralMidi2ProgramData
        {
            ...
            public GeneralMidi2ProgramData(GeneralMidi2Program generalMidi2Program,
                GeneralMidiProgram generalMidiProgram, SevenBitNumber bankMsb, SevenBitNumber bankLsb)
            {
        ...
        private static IEnumerable<GeneralMidi2ProgramData> GetProgramsData(GeneralMidiProgram generalMidiProgram,
            params GeneralMidi2Program[] programs)
        {
