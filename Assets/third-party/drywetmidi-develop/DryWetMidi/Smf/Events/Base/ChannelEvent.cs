...
namespace Melanchall.DryWetMidi.Smf
{
    ...
    public abstract class ChannelEvent : MidiEvent
    {
        ...
        ///     An invalid value for channel
        ///     event's parameter was encountered.
        /// </exception>
                ...
                if (parameter > SevenBitNumber.MaxValue)
                    switch (settings.InvalidChannelEventParameterValuePolicy)
                    {
                        case InvalidChannelEventParameterValuePolicy.Abort:
                            throw new InvalidChannelEventParameterValueException(
                                $"{parameter} is invalid value for channel event's parameter.", parameter);
        ...
        {
            foreach (var parameter in _parameters) writer.WriteByte(parameter);
        }
