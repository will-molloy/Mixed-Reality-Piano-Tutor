...
namespace Melanchall.DryWetMidi.Smf
{
    ...
    public sealed class ChunkTypesCollection : IEnumerable<ChunkType>
    {
        ...
        ///     <paramref name="type" /> is null. -or- <paramref name="id" />
        ///     is null.
        /// </exception>
        /// <exception cref="ArgumentException">
        ///     Chunk type specified by <paramref name="type" /> and
        ///     <paramref name="id" /> already exists in the <see cref="ChunksCollection" />.
        /// </exception>
        ...
        /// </param>
        /// <returns>
        ///     true if the <see cref="ChunkTypesCollection" /> contains a chunk type with the
        ...
        /// </param>
        /// <returns>
        ///     true if the <see cref="ChunkTypesCollection" /> contains an ID for the
        ///     specified chunk type; otherwise, false.
        /// </returns>
