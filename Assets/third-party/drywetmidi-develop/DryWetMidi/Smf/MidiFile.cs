...
namespace Melanchall.DryWetMidi.Smf
{
    ...
    public sealed class MidiFile
    {
        ...
        ///     Actual header or track chunk's size differs from the one declared
        ///     in its header and that should be treated as error according to the <paramref name="settings" />.
        /// </exception>
        /// <exception cref="UnknownChunkException">
        ///     Chunk to be read has unknown ID and that
        ///     should be treated as error accordng to the <paramref name="settings" />.
        /// </exception>
        /// <exception cref="UnexpectedTrackChunksCountException">
        ///     Actual track chunks
        ///     count differs from the expected one and that should be treated as error according to
        ///     the specified <paramref name="settings" />.
        /// </exception>
        /// <exception cref="UnknownFileFormatException">
        ///     The header chunk contains unknown file format and
        ///     <see cref="ReadingSettings.UnknownFileFormatPolicy" /> property of the <paramref name="settings" /> set to
        ///     <see cref="UnknownFileFormatPolicy.Abort" />.
        /// </exception>
        /// <exception cref="InvalidChannelEventParameterValueException">
        ///     Value of a channel event's parameter
        ///     just read is invalid.
        /// </exception>
        /// <exception cref="InvalidMetaEventParameterValueException">
        ///     Value of a meta event's parameter
        ///     just read is invalid.
        /// </exception>
        /// <exception cref="UnknownChannelEventException">Reader has encountered an unknown channel event.</exception>
        /// <exception cref="NotEnoughBytesException">
        ///     MIDI file cannot be read since the reader's underlying stream doesn't
        ///     have enough bytes.
        /// </exception>
        /// <exception cref="UnexpectedRunningStatusException">Unexpected running status is encountered.</exception>
        /// <exception cref="MissedEndOfTrackEventException">
        ///     Track chunk doesn't end with End Of Track event and that
        ///     should be treated as error accordng to the specified <paramref name="settings" />.
        /// </exception>
        ...
        ///     If true and file specified by <paramref name="filePath" /> already
        ///     exists it will be overwritten; if false and the file exists exception will be thrown.
        /// </param>
        ...
        /// <exception cref="TooManyTrackChunksException">
        ///     Count of track chunks presented in the file
        ///     exceeds maximum value allowed for MIDI file.
        /// </exception>
        public void Write(string filePath, bool overwriteFile = false,
            MidiFileFormat format = MidiFileFormat.MultiTrack, WritingSettings settings = null)
        {
        ...
        /// <exception cref="ArgumentException">
        ///     <paramref name="stream" /> doesn't support reading. -or
        ///     <paramref name="stream" /> doesn't support seeking. -or- <paramref name="stream" /> is already read.
        /// </exception>
        /// <exception cref="IOException">An I/O error occurred while reading from the stream.</exception>
        /// <exception cref="ObjectDisposedException">
        ///     <paramref name="stream" /> is disposed. -or-
        ///     Underlying stream reader is disposed.
        /// </exception>
        /// <exception cref="NotSupportedException">
        ///     Unable to get position of the <paramref name="stream" />. -or
        ///     Unable to get length of the <paramref name="stream" />.
        /// </exception>
        /// <exception cref="NoHeaderChunkException">There is no header chunk in a file.</exception>
        /// <exception cref="InvalidChunkSizeException">
        ///     Actual header or track chunk's size differs from the one declared
            ...
            try
            {
                using (var reader = new MidiReader(stream))
                {
                    ...
                    if (expectedTrackChunksCount != null && actualTrackChunksCount != expectedTrackChunksCount)
                        ReactOnUnexpectedTrackChunksCount(settings.UnexpectedTrackChunksCountPolicy,
                            actualTrackChunksCount, expectedTrackChunksCount.Value);
                }
        ...
        /// <exception cref="ObjectDisposedException">
        ///     <paramref name="stream" /> is disposed. -or-
        ///     Underlying stream writer is disposed.
        /// </exception>
        /// <exception cref="TooManyTrackChunksException">
        ///     Count of track chunks presented in the file
        ///     exceeds maximum value allowed for MIDI file.
        /// </exception>
        public void Write(Stream stream, MidiFileFormat format = MidiFileFormat.MultiTrack,
            WritingSettings settings = null)
        {
            ...
            using (var writer = new MidiWriter(stream))
            {
                ...
                {
                    if (settings.CompressionPolicy.HasFlag(CompressionPolicy.DeleteUnknownChunks) &&
                        chunk is UnknownChunk)
                        continue;
        ...
        /// </exception>
        /// <exception cref="InvalidChunkSizeException">
        ///     Actual chunk's size differs from the one declared
        ///     in its header and that should be treated as error according to the specified
        ///     <paramref name="settings" />.
        /// </exception>
        /// <exception cref="UnknownChannelEventException">Reader has encountered an unknown channel event.</exception>
        /// <exception cref="NotEnoughBytesException">
        ///     Value cannot be read since the reader's underlying stream
        ///     doesn't have enough bytes.
        /// </exception>
        /// <exception cref="UnexpectedRunningStatusException">Unexpected running status is encountered.</exception>
        /// <exception cref="MissedEndOfTrackEventException">
        ///     Track chunk doesn't end with End Of Track event and that
        ...
        ///     just read is invalid.
        /// </exception>
        private static MidiChunk ReadChunk(MidiReader reader, ReadingSettings settings, int actualTrackChunksCount,
            int? expectedTrackChunksCount)
        {
            ...
            try
            {
                ...
                if (chunk is TrackChunk && expectedTrackChunksCount != null &&
                    actualTrackChunksCount >= expectedTrackChunksCount)
                {
                    ReactOnUnexpectedTrackChunksCount(settings.UnexpectedTrackChunksCountPolicy, actualTrackChunksCount,
                        expectedTrackChunksCount.Value);
        ...
        /// <param name="expectedTrackChunksCount">Expected count of track chunks.</param>
        /// <exception cref="UnexpectedTrackChunksCountException">
        ///     Difference between expected track chunks
        ///     count and the actual one is unallowable due to the <paramref name="policy" />.
        /// </exception>
        private static void ReactOnUnexpectedTrackChunksCount(UnexpectedTrackChunksCountPolicy policy,
            int actualTrackChunksCount, int expectedTrackChunksCount)
        {
            switch (policy)
            {
        ...
        /// <exception cref="NotEnoughBytesException">
        ///     Lack of bytes in the reader's underlying stream needed to
        ///     read a value is unallowable due to the <paramref name="policy" />.
        /// </exception>
        ...
        /// <param name="chunksTypes">
        ///     Collection of the chunks types to search for the one with
        ///     <paramref name="chunkId" /> ID.
        /// </param>
        /// <returns>
        ///     An instance of the chunk type with the specified ID or null if <paramref name="chunksTypes" />
        ///     doesn't contain chunk type with it.
        /// </returns>
