...
namespace Melanchall.DryWetMidi.Smf
{
    ...
    public sealed class ChunksCollection : IEnumerable<MidiChunk>
    {
        ...
        /// </summary>
        /// <remarks>
        ///     Note that header chunks cannot be inserted into the collection since it may cause inconsistence in the file
        ///     structure.
        ///     Header chunk with appropriate information will be written to a file automatically on
        ///     <see cref="MidiFile.Write(string, bool, MidiFileFormat, WritingSettings)" />.
        /// </remarks>
        ...
        /// <returns>
        ///     true if chunk is successfully removed; otherwise, false. This method also returns
        ...
        /// <returns>
        ///     The zero-based index of the first occurrence of chunk within the entire
        ///     <see cref="ChunksCollection" />, if found; otherwise, –1.
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="chunk" /> is null.</exception>
