    ...
    public sealed class MidiReader : IDisposable
    {
        ...
        public ushort ReadWord()
        {
            ...
            if (bytes.Length < wordSize)
                throw new NotEnoughBytesException("Not enough bytes in the stream to read a WORD.", wordSize,
                    bytes.Length);
        ...
        public uint ReadDword()
        {
            ...
            if (bytes.Length < dwordSize)
                throw new NotEnoughBytesException("Not enough bytes in the stream to read a DWORD.", dwordSize,
                    bytes.Length);
        ...
        public short ReadInt16()
        {
            ...
            if (bytes.Length < int16Size)
                throw new NotEnoughBytesException("Not enough bytes in the stream to read a INT16.", int16Size,
                    bytes.Length);
        ...
        ///     Not enough bytes in the stream to read a variable-length quantity
        ///     number.
        /// </exception>
        /// <exception cref="ObjectDisposedException">Method was called after the reader was disposed.</exception>
        /// <exception cref="IOException">An I/O error occurred on the underlying stream.</exception>
        ...
        public long ReadVlqLongNumber()
        {
            ...
            catch (EndOfStreamException ex)
            {
                throw new NotEnoughBytesException(
                    "Not enough bytes in the stream to read a variable-length quantity number.", ex);
            }
        ...
        public uint Read3ByteDword()
        {
            ...
            var bytes = ReadBytes(dwordSize);
            if (bytes.Length < dwordSize)
                throw new NotEnoughBytesException("Not enough bytes in the stream to read a 3-byte DWORD.", dwordSize,
                    bytes.Length);
