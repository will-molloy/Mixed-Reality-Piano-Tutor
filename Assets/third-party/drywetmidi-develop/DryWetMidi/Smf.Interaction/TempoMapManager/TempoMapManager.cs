...
namespace Melanchall.DryWetMidi.Smf.Interaction
{
    ...
    public sealed class TempoMapManager : IDisposable
    {
        ...
        ///     Collection of <see cref="EventsCollection" /> which hold events that
        ///     represent tempo map of a MIDI file.
        /// </param>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="timeDivision" /> is null. -or-
        ///     <paramref name="eventsCollections" /> is null.
        /// </exception>
        ...
        /// <param name="endTime">End of time range to remove changes of time signature in.</param>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="startTime" /> is null. -or-
        ///     <paramref name="endTime" /> is null.
        /// </exception>
        ...
        public void SaveChanges()
        {
            ...
            foreach (var events in _timedEventsManagers.Select(m => m.Events)) events.RemoveAll(IsTempoMapEvent);
            ...
            foreach (var timedEventsManager in _timedEventsManagers) timedEventsManager.SaveChanges();
        }
