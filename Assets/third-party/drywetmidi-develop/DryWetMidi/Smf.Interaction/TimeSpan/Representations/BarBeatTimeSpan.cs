...
namespace Melanchall.DryWetMidi.Smf.Interaction
{
    ...
    public sealed class BarBeatTimeSpan : ITimeSpan
    {
        ...
        ///     <paramref name="bars" /> is negative. -or-
        ///     <paramref name="beats" /> is negative.
        /// </exception>
        ...
        /// <exception cref="ArgumentOutOfRangeException">
        ///     <paramref name="bars" /> is negative. -or-
        ///     <paramref name="beats" /> is negative. -or- <paramref name="ticks" /> is negative.
        /// </exception>
        ...
        /// <param name="timeSpan">
        ///     When this method returns, contains the <see cref="BarBeatTimeSpan" />
        ...
        /// <param name="input">A string containing a time span to convert.</param>
        /// <returns>
        ///     A <see cref="BarBeatTimeSpan" /> equivalent to the time span contained in
        ///     <paramref name="input" />.
        /// </returns>
