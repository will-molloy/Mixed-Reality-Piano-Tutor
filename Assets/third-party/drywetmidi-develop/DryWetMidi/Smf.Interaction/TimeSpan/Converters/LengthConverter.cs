...
namespace Melanchall.DryWetMidi.Smf.Interaction
{
    ...
    public static class LengthConverter
    {
        ...
        ///     <paramref name="length" /> is negative. -or-
        ...
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="length" /> is null. -or-
        ///     <paramref name="tempoMap" /> is null.
        /// </exception>
        /// <exception cref="NotSupportedException"><typeparamref name="TTimeSpan" /> is not supported.</exception>
        ...
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="length" /> is null. -or-
        ///     <paramref name="time" /> is null. -or- <paramref name="tempoMap" /> is null.
        /// </exception>
        /// <exception cref="NotSupportedException"><typeparamref name="TTimeSpan" /> is not supported.</exception>
        ...
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="length" /> is null. -or-
        ///     <paramref name="lengthType" /> is null. -or- <paramref name="tempoMap" /> is null.
        /// </exception>
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="time" /> is negative.</exception>
