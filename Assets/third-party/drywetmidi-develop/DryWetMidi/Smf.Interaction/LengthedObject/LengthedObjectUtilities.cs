...
namespace Melanchall.DryWetMidi.Smf.Interaction
{
    ...
    public static class LengthedObjectUtilities
    {
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="objects" /> is null. -or- <paramref name="time" /> is null. -or-
        ///     <paramref name="tempoMap" /> is null. -or- One of the objects is null.
        /// </exception>
        public static IEnumerable<TObject> StartAtTime<TObject>(this IEnumerable<TObject> objects, ITimeSpan time,
            TempoMap tempoMap)
            where TObject : ILengthedObject
        {
        ...
        ///     <paramref name="tempoMap" /> is null. -or- One of the objects is null.
        /// </exception>
        public static IEnumerable<TObject> EndAtTime<TObject>(this IEnumerable<TObject> objects, ITimeSpan time,
            TempoMap tempoMap)
            where TObject : ILengthedObject
        {
        ...
        /// </exception>
        /// <exception cref="InvalidEnumArgumentException"><paramref name="matchBy" /> specified an invalid value.</exception>
        public static IEnumerable<TObject> AtTime<TObject>(this IEnumerable<TObject> objects, ITimeSpan time,
            TempoMap tempoMap, LengthedObjectPart matchBy)
            where TObject : ILengthedObject
        {
            ThrowIfArgument.IsNull(nameof(objects), objects);
