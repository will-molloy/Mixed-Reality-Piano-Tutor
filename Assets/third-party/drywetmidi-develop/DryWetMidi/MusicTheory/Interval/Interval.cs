...
namespace Melanchall.DryWetMidi.MusicTheory
{
    ...
    public sealed class Interval
    {
        ...
        ///     <paramref name="direction" /> specified an
        ///     invalid value.
        /// </exception>
        ...
        ///     <paramref name="halfSteps" /> is out of range
        ///     (result interval is out of the [-127,127] range).
        /// </exception>
        ...
        /// <param name="interval">
        ///     When this method returns, contains the <see cref="Interval" />
        ...
        /// <returns>
        ///     The <see cref="Interval" /> which is the <paramref name="interval" />
        ///     shifted by the <paramref name="halfSteps" />.
        /// </returns>
        ...
        /// <returns>
        ///     The <see cref="Interval" /> which is the <paramref name="interval" />
        ///     stretched by the <paramref name="multiplier" />.
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="interval" /> is null.</exception>
        /// <exception cref="ArgumentOutOfRangeException">
        ///     <paramref name="multiplier" /> is out of range
        ///     (result interval is out of the [-127,127] range).
        /// </exception>
        ...
        /// <returns>
        ///     The <see cref="Interval" /> which is the <paramref name="interval" />
        ///     shrinked by the <paramref name="divisor" />.
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="interval" /> is null.</exception>
