...
namespace Melanchall.DryWetMidi.MusicTheory
{
    ...
    public static class ScaleIntervals
    {
        ...
        /// </summary>
        [DisplayName("blues")] public static readonly IEnumerable<Interval> Blues = GetIntervals(3, 2, 1, 1, 3, 2);

        /// <summary>
        ///     'Chinese' scale's intervals sequence.
        /// </summary>
        [DisplayName("chinese")] public static readonly IEnumerable<Interval> Chinese = GetIntervals(4, 2, 1, 4, 1);
        ...
        /// </summary>
        [DisplayName("dorian")] public static readonly IEnumerable<Interval> Dorian = GetIntervals(2, 1, 2, 2, 2, 1, 2);
        ...
        /// </summary>
        [DisplayName("egyptian")] public static readonly IEnumerable<Interval> Egyptian = GetIntervals(2, 3, 2, 3, 2);
        ...
        /// </summary>
        [DisplayName("gypsy")] public static readonly IEnumerable<Interval> Gypsy = GetIntervals(1, 3, 1, 2, 1, 3, 1);
        ...
        /// </summary>
        [DisplayName("hindu")] public static readonly IEnumerable<Interval> Hindu = GetIntervals(2, 2, 1, 2, 1, 2, 2);

        /// <summary>
        ///     'Hirajoshi' scale's intervals sequence.
        /// </summary>
        [DisplayName("hirajoshi")] public static readonly IEnumerable<Interval> Hirajoshi = GetIntervals(2, 1, 4, 1, 4);
        ...
        /// </summary>
        [DisplayName("in-sen")] public static readonly IEnumerable<Interval> InSen = GetIntervals(1, 4, 2, 3, 2);

        /// <summary>
        ///     'Indian' scale's intervals sequence.
        /// </summary>
        [DisplayName("indian")] public static readonly IEnumerable<Interval> Indian = GetIntervals(4, 1, 2, 3, 2);

        /// <summary>
        ///     'Ionian' scale's intervals sequence.
        /// </summary>
        [DisplayName("ionian")] public static readonly IEnumerable<Interval> Ionian = GetIntervals(2, 2, 1, 2, 2, 2, 1);
        ...
        /// </summary>
        [DisplayName("iwato")] public static readonly IEnumerable<Interval> Iwato = GetIntervals(1, 4, 1, 4, 2);
        ...
        /// </summary>
        [DisplayName("kumoi")] public static readonly IEnumerable<Interval> Kumoi = GetIntervals(2, 1, 4, 2, 3);
        ...
        /// </summary>
        [DisplayName("lydian")] public static readonly IEnumerable<Interval> Lydian = GetIntervals(2, 2, 2, 1, 2, 2, 1);
        ...
        /// </summary>
        [DisplayName("major")] public static readonly IEnumerable<Interval> Major = GetIntervals(2, 2, 1, 2, 2, 2, 1);
        ...
        /// </summary>
        [DisplayName("minor")] public static readonly IEnumerable<Interval> Minor = GetIntervals(2, 1, 2, 2, 1, 2, 2);
        ...
        /// </summary>
        [DisplayName("pelog")] public static readonly IEnumerable<Interval> Pelog = GetIntervals(1, 2, 4, 1, 4);
        ...
        /// </summary>
        [DisplayName("piongio")] public static readonly IEnumerable<Interval> Piongio = GetIntervals(2, 3, 2, 2, 1, 2);
        ...
        /// </summary>
        [DisplayName("ritusen")] public static readonly IEnumerable<Interval> Ritusen = GetIntervals(2, 3, 2, 2, 3);
        ...
        /// </summary>
        [DisplayName("scriabin")] public static readonly IEnumerable<Interval> Scriabin = GetIntervals(1, 3, 3, 2, 3);
