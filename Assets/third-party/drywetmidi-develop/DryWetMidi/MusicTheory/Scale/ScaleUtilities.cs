...
namespace Melanchall.DryWetMidi.MusicTheory
{
    ...
    public static class ScaleUtilities
    {
        ...
        /// <param name="degree">
        ///     <see cref="ScaleDegree" /> representing a degree of the
        ///     <paramref name="scale" />.
        /// </param>
        ...
        ///     <paramref name="degree" /> specified an
        ///     invalid value.
        /// </exception>
        ...
        public static IEnumerable<Note> GetNotes(this Scale scale)
        {
            ...
            var noteNumber = Enumerable
                .Range(SevenBitNumber.MinValue, SevenBitNumber.MaxValue - SevenBitNumber.MinValue + 1)
        ...
        /// <returns>
        ///     Notes that belong to the <paramref name="scale" /> in ascending order starting with
        ///     the <paramref name="rootNote" />.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="scale" /> is null. -or-
        ...
        /// <param name="rootNote"><see cref="Note" /> to start a sequence of scale's notes with.</param>
        /// <returns>
        ///     Notes that belong to the <paramref name="scale" /> in descending order starting with
        ///     the <paramref name="rootNote" />.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="scale" /> is null. -or-
        ...
        /// <param name="note">
        ///     <see cref="Note" /> to check if it belongs to the <paramref name="scale" />
        ///     or not.
        /// </param>
        /// <returns>
        ///     true if <paramref name="note" /> belongs to the <paramref name="scale" />;
        ///     otherwise, false.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="scale" /> is null. -or-
        ///     <paramref name="note" /> is null.
        /// </exception>
        ...
        /// <returns>
        ///     A note next to the <paramref name="note" /> that belongs to the
        ///     <paramref name="scale" />.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="scale" /> is null. -or-
        ...
        /// <returns>
        ///     A note previous to the <paramref name="note" /> that belongs to the
        ///     <paramref name="scale" />.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="scale" /> is null. -or-
