...
namespace sl
{
	...
	/// <summary>
	///     Status for self calibration. Since v0.9.3, self-calibration is done in background and start in the
	///     sl.ZEDCamera.Init or Reset function.
	/// </summary>
	...
	public enum ERROR_CODE
    {
	    ...
	    /// <summary>
	    ///     This issue can occurs when the camera FPS cannot be reached, due to a lot of corrupted frames. Try to change USB
	    ///     port.
	    /// </summary>
	    LOW_USB_BANDWIDTH,
	    ...
	    /// <summary>
	    ///     ZED calibration file is not valid, try to download the factory one or recalibrate your camera using 'ZED
	    ///     Calibration
	    /// </summary>
	    ...
	    /// <summary>
	    ///     The area file does not contain enought data to be used or the sl::DEPTH_MODE used during the creation of the area
	    ///     file is different from the one currently set.
	    /// </summary>
	    ...
	    /// <summary>
	    ///     Plane not found, either no plane is detected in the scene, at the location or corresponding to the floor, or the
	    ///     floor plane doesn't match the prior given
	    /// </summary>
	...
	public enum CAMERA_SETTINGS
    {
	    ...
	    /// <summary>
	    ///     Defines the gain control. Affected value should be between 0 and 100 for manual control. If ZED_EXPOSURE is set to
	    ///     -1, the gain is in auto mode too.
	    /// </summary>
	    GAIN,

	    /// <summary>
	    ///     Defines the exposure control. A -1 value enable the AutoExposure/AutoGain control. Affected value should be between
	    ///     0 and 100 for manual control. A 0 value only disable auto mode without modifing the last auto values, while a 1 to
	    ///     100 value disable auto mode and set exposure to chosen value
	    /// </summary>
	    EXPOSURE,

	    /// <summary>
	    ///     Defines the color temperature control. Affected value should be between 2800 and 6500 with a step of 100. A value
	    ///     of -1 set the AWB ( auto white balance), as the boolean parameter (default) does.
	    /// </summary>
	    WHITEBALANCE
    }
	...
	public enum MEASURE
    {
	    ...
	    /// <summary>
	    ///     3D coordinates and Color of the image , 4 channels, FLOAT (the 4th channel encode 4 UCHAR for color in R-G-B-A
	    ///     order)
	    /// </summary>
	    XYZRGBA,

	    /// <summary>
	    ///     3D coordinates and Color of the image , 4 channels, FLOAT (the 4th channel encode 4 UCHAR for color in B-G-R-A
	    ///     order)
	    /// </summary>
	    XYZBGRA,

	    /// <summary>
	    ///     3D coordinates and Color of the image , 4 channels, FLOAT (the 4th channel encode 4 UCHAR for color in A-R-G-B
	    ///     order)
	    /// </summary>
	    XYZARGB,
	    ...
	    /// <summary>
	    ///     3D coordinates and Color of the image , 4 channels, FLOAT (the 4th channel encode 4 UCHAR for color in A-B-G-R
	    ///     order)
	    /// </summary>
	    NORMALS,
	...
	public enum SPATIAL_MAPPING_STATE
    {
	    ...
	    /// <summary>
	    ///     Effective FPS is too low to give proper results for spatial mapping. Consider using PERFORMANCES parameters
	    ///     (DEPTH_MODE_PERFORMANCE, low camera resolution (VGA,HD720), spatial mapping low resolution)
	    /// </summary>
	...
	public class InitParameters
    {
	    ...
	    /// <summary>
	    ///     If set to true, it will disable self-calibration and take the optional calibration parameters without optimizing
	    ///     them.
	    ...
	    /// <summary>
	    ///     This defines the order and the direction of the axis of the coordinate system. see COORDINATE_SYSTEM for more
	    ///     information.
	    /// </summary>
    ...
    {
	    /// <summary>
	    ///     Standard coordinates system in computer vision. Used in OpenCV : see here :
    ...
    public struct RuntimeParameters
    {
	    ...
	    /// </summary>
	    [MarshalAs(UnmanagedType.U1)] [FieldOffset(21)]
