...
public class ZEDLogMessage
{
    ...
    private static readonly string zed_sdk_version = "v2.4";
	...
	/// <returns></returns>
	public static string Error2Str(ERROR error)
    {
        switch (error)
        {
            ...
            case ERROR.VR_CAMERA_RIG_NOT_FOUND:
                return
                    "Warning: No VR CameraRig object found. Make sure you attach the CameraRig SteamVR Prefab in the project to be able to use a VR controller.\n Otherwise, make sure the tracking is activated in the ZED Manager interface";
            ...
            case ERROR.PAD_CAMERA_CALIBRATION_MISMATCH:
                return
                    "Warning: VR Controller and ZED Camera must be calibrated before use (by using the GreenScreen Calibration tool). \n It seems that the current controller has not been calibrated.";
            ...
            case ERROR.SDK_DEPENDENCIES_ISSUE:
                return "The ZED plugin cannot be loaded. \n Please check that you have the latest ZED SDK " +
                       zed_sdk_version + " installed" +
                       "\n\n If the problem persists, please contact our support team at support@stereolabs.com\n";
            case ERROR.NAVMESH_NOT_GENERATED:
                return
                    "The NavMesh cannot be generated, please change the settings of the agent, or scan a wider zone.";
