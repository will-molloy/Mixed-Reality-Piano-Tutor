...
public class GreenScreenManager : MonoBehaviour
{
    ...
    [SerializeField] public float blackClip;
    ...
    ///     Current canal used
    /// </summary>
    [HideInInspector] [SerializeField] public CANAL canal = CANAL.FINAL;
    ...
    /// </summary>
    private readonly Color defaultColor = new Color(0.0f, 1.0f, 0.0f, 1);

    public bool enableGarbageMatte;

    /// <summary>
    ///     Erosion value
    /// </summary>
    [HideInInspector] [SerializeField] public int erosion;
    ...
    [SerializeField] [HideInInspector] public GarbageMatte garbageMatte = new GarbageMatte();
    ...
    /// </summary>
    [SerializeField] public Color keyColors = new Color(0.0f, 1.0f, 0.0f, 1);
    ...
    /// </summary>
    [SerializeField] public string pathFileConfig = "Assets/Config_greenscreen.json";
    ...
    /// </summary>
    public ZEDRenderingPlane screenManager;
    ...
    ///     Array of available blend
    /// </summary>
    [SerializeField] public float spill = 0.2f;

    private bool textureOverlayInit;

    private bool toUpdateConfig;
    ...
    ///     CutOff value
    /// </summary>
    [SerializeField] public float whiteClip = 1.0f;

    public RenderTexture FinalTexture => finalTexture;
    ...
    {
        finalTexture = new RenderTexture(ZEDCamera.GetInstance().ImageWidth, ZEDCamera.GetInstance().ImageHeight, 0,
        ...
        matYUV.SetInt("_isLinear", Convert.ToInt32(QualitySettings.activeColorSpace));
        ...
        UpdateShader();
        UpdateCanal();
        if (File.Exists("ZED_Settings.conf"))
        {
            ZEDCamera.GetInstance().LoadCameraSettings("ZED_Settings.conf");
            ZEDCamera.GetInstance().SetCameraSettings();
        }
    }
    ...
    {
        foreach (CANAL c in Enum.GetValues(typeof(CANAL))) manageKeyWord(false, c.ToString());
    ...
    public void Reset()
    {
        ...
        if (zedManager != null)
        {
            zedManager.resolution = RESOLUTION.HD1080;
    ...
    private Vector3 RGBtoYUV(Color rgb, bool clamped = true)
    {
    ...
    private bool LoadData(out GreenScreenData gsData)
    {
        ...
        {
            var dataAsJson = File.ReadAllText(pathFileConfig);
    ...
    public void LoadGreenScreenData(bool forceGargabeMatte = false)
    {
        ...
        {
            var chromaKeyData = gsData.chromaKeyData;
    ...
    private void OnPreRender()
    {
        ...
        var tempAlpha = RenderTexture.GetTemporary(finalTexture.width, finalTexture.height, 0,
            RenderTextureFormat.RFloat, RenderTextureReadWrite.Linear);
        var tempFinalAlpha = RenderTexture.GetTemporary(finalTexture.width, finalTexture.height, 0,
            RenderTextureFormat.ARGB32, RenderTextureReadWrite.Linear);
