...
namespace MK.Glow
{
    ...
    public class MKGlowFree : MonoBehaviour
    {
        ...
        private static readonly float[] gaussFilter = new float[11]
        {
...
#pragma warning disable 414
        [SerializeField] private bool showMainBehavior = true;
        [SerializeField] private bool showInnerGlowBehavior;
#pragma warning restore 414
        ...
        private void Blur(RenderTexture main, RenderTexture tmpMain)
        {
            ...
            {
                var offsetInner = i * (blurSpreadInner * BLUR_SPREAD_INNTER_MULT) / blurIterations / samples;
        ...
        private Camera SelectiveGlowCamera
        {
            get
            {
                if (selectiveGlowCamera == null) selectiveGlowCamera = SelectiveGlowCameraObject.GetComponent<Camera>();
...
#else
                    glowTexRaw =
 RenderTexture.GetTemporary((int)((Cam.pixelWidth) / samples), (int)((Cam.pixelHeight) / samples), 16, rtFormat, RenderTextureReadWrite.Default, 1);
#endif
                    SetupGlowCamera();
            ...
            compositeMaterial.SetFloat("_GlowIntensityInner",
                glowIntensityInner * (glowType != GlowType.Fullscreen ? GLOW_INTENSITY_MULT * blurSpreadInner : 10.0f));
        ...
        private void OnRenderImage(RenderTexture src, RenderTexture dest)
        {
            ...
            var glowTexInner = GetTemporaryRT(srcWidth, srcHeight, src.vrUsage);
            var tmpGlowTex = GetTemporaryRT(srcWidth, srcHeight, src.vrUsage);
#else
