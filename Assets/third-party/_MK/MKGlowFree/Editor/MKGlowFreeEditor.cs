...
namespace MK.Glow
{
    ...
    public class MKGlowEditor : Editor
    {
        ...
        private static readonly GUIContent glowTintLabel = new GUIContent("Glow Tint",
            "The glows coloration in full screen mode(only FullscreenGlowType)");

        private SerializedProperty blurIterations;
        private SerializedProperty blurSpreadInner;
        private readonly ColorPickerHDRConfig colorPickerHDRConfig = new ColorPickerHDRConfig(0f, 99f, 1 / 99f, 3f);
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (HandleBehavior("Main", ref showMainBehavior))
            {
                ...
                if (glowType.enumValueIndex == 0) EditorGUILayout.PropertyField(glowLayer);
                ...
                glowTint.colorValue = EditorGUILayout.ColorField(glowTintLabel, glowTint.colorValue, false, false,
                    false, colorPickerHDRConfig);
            }
