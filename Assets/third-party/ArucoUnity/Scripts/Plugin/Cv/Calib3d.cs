...
namespace ArucoUnity.Plugin
{
    public static partial class Cv
    {
        ...
        private static extern double au_cv_calib3d_calibrateCamera1(IntPtr objectPoints, IntPtr imagePoints,
            IntPtr imageSize,
        ...
        [DllImport("ArucoUnityPlugin")]
        private static extern double au_cv_calib3d_calibrateCamera2(IntPtr objectPoints, IntPtr imagePoints,
            IntPtr imageSize,
            IntPtr cameraMatrix, IntPtr distCoeffs, out IntPtr rvecs, out IntPtr tvecs, int flags, IntPtr criteria,
            IntPtr exception);

        [DllImport("ArucoUnityPlugin")]
        private static extern IntPtr au_cv_calib3d_initCameraMatrix2D(IntPtr objectPoints, IntPtr imagePoints,
            IntPtr imageSize,
            double aspectRatio, IntPtr exception);

        [DllImport("ArucoUnityPlugin")]
        private static extern void au_cv_calib3d_Rodrigues1(IntPtr rotationVector, out IntPtr rotationMatrix,
            IntPtr exception);

        [DllImport("ArucoUnityPlugin")]
        private static extern void au_cv_calib3d_Rodrigues2(IntPtr rotationMatrix, out IntPtr rotationVector,
            IntPtr exception);

        [DllImport("ArucoUnityPlugin")]
        private static extern double au_cv_calib3d_stereoCalibrate(IntPtr objectPoints, IntPtr imagePoints1,
            IntPtr imagePoints2,
        ...
        [DllImport("ArucoUnityPlugin")]
        private static extern void au_cv_calib3d_stereoRectify(IntPtr cameraMatrix1, IntPtr distCoeffs1,
        ...
        [DllImport("ArucoUnityPlugin")]
        private static extern IntPtr au_cv_calib3d_getOptimalNewCameraMatrix(IntPtr cameraMatrix, IntPtr distCoeffs,
        ...
        public static double CalibrateCamera(Std.VectorVectorPoint3f objectPoints, Std.VectorVectorPoint2f imagePoints,
            ...
            Std.VectorDouble stdDeviationsExtrinsics, Std.VectorDouble perViewErrors, Calib flags,
            TermCriteria criteria)
        {
            var exception = new Exception();
            IntPtr rvecsPtr, tvecsPtr;

            var error = au_cv_calib3d_calibrateCamera1(objectPoints.CppPtr, imagePoints.CppPtr, imageSize.CppPtr,
                cameraMatrix.CppPtr,
                distCoeffs.CppPtr, out rvecsPtr, out tvecsPtr, stdDeviationsIntrinsics.CppPtr,
                stdDeviationsExtrinsics.CppPtr, perViewErrors.CppPtr,
        ...
        public static Mat InitCameraMatrix2D(Std.VectorVectorPoint3f objectPoints, Std.VectorVectorPoint2f imagePoints,
            Size imageSize,
            double aspectRatio = 1.0)
        {
            var exception = new Exception();
            var cameraMatrixPtr = au_cv_calib3d_initCameraMatrix2D(objectPoints.CppPtr, imagePoints.CppPtr,
                imageSize.CppPtr, aspectRatio,
                exception.CppPtr);
            exception.Check();
        ...
        public static void StereoRectify(Mat cameraMatrix1, Mat distCoeffs1, Mat cameraMatrix2, Mat distCoeffs2,
            ...
            Rect validPixROI1)
        {
            var validPixROI2 = new Rect();
            StereoRectify(cameraMatrix1, distCoeffs1, cameraMatrix2, distCoeffs2, imageSize, rotationMatrix, tvec,
                out rectificationMatrix1,
                out rectificationMatrix2, out projectionMatrix1, out projectionMatrix2, out disparityMatrix, flags,
                scalingFactor, newImageSize,
        ...
        public static void StereoRectify(Mat cameraMatrix1, Mat distCoeffs1, Mat cameraMatrix2, Mat distCoeffs2,
            ...
            Vec3d tvec, out Mat rectificationMatrix1, out Mat rectificationMatrix2, out Mat projectionMatrix1,
            out Mat projectionMatrix2,
            out Mat disparityMatrix, StereoRectifyFlags flags = StereoRectifyFlags.ZeroDisparity,
        ...
        public static Mat GetOptimalNewCameraMatrix(Mat cameraMatrix, Mat distCoeffs, Size imageSize,
            double scalingFactor, Size newImageSize,
            Rect validPixRoi, bool centerPrincipalPoint = false)
        {
            var exception = new Exception();
            IntPtr newCameraMatrixPtr;

            newCameraMatrixPtr = au_cv_calib3d_getOptimalNewCameraMatrix(cameraMatrix.CppPtr, distCoeffs.CppPtr,
                imageSize.CppPtr, scalingFactor,
