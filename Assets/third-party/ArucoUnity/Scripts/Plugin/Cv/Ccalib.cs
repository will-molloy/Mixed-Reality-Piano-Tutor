...
namespace ArucoUnity.Plugin
{
    public static partial class Cv
    {
        public static class Omnidir
        {
            ...
            private static extern double au_cv_ccalib_omnidir_calibrate(IntPtr objectPoints, IntPtr imagePoints,
                IntPtr imageSize,
            ...
            [DllImport("ArucoUnityPlugin")]
            private static extern void au_cv_ccalib_omnidir_initUndistortRectifyMap(IntPtr cameraMatrix,
                IntPtr distCoeffs, IntPtr xi,
                IntPtr R, IntPtr newCameraMatrix, IntPtr size, int m1type, out IntPtr map1, out IntPtr map2, int flags,
                IntPtr exception);

            [DllImport("ArucoUnityPlugin")]
            private static extern double au_cv_ccalib_omnidir_stereoCalibrate(IntPtr objectPoints, IntPtr imagePoints1,
                IntPtr imagePoints2,
            ...
            [DllImport("ArucoUnityPlugin")]
            private static extern void au_cv_ccalib_omnidir_stereoRectify(IntPtr rvec, IntPtr tvec, out IntPtr R1,
                out IntPtr R2,
                IntPtr exception);

            [DllImport("ArucoUnityPlugin")]
            private static extern void au_cv_ccalib_omnidir_undistortImage(IntPtr distorted, out IntPtr undistorted,
                IntPtr cameraMatrix,
            ...
            public static void InitUndistortRectifyMap(Mat cameraMatrix, Mat distCoeffs, Mat xi, Mat R,
                Mat newCameraMatrix, Size size, Type m1type,
                out Mat map1, out Mat map2, Rectifify flags)
            {
                var exception = new Exception();
                IntPtr map1Ptr, map2Ptr;

                au_cv_ccalib_omnidir_initUndistortRectifyMap(cameraMatrix.CppPtr, distCoeffs.CppPtr, xi.CppPtr,
                    R.CppPtr, newCameraMatrix.CppPtr, size.CppPtr,
            ...
            {
                var R = new Mat(3, 3, Type.CV_64F, new double[9] {1, 0, 0, 0, 1, 0, 0, 0, 1});
