      ...
      public enum InterpolationFlags
        {
            ...
            /// Fills all of the destination image pixels.
        ...
        private static extern void au_cv_imgproc_initUndistortRectifyMap(IntPtr cameraMatrix, IntPtr distCoeffs,
            IntPtr R,
            IntPtr newCameraMatrix, IntPtr size, int m1type, out IntPtr map1, out IntPtr map2, IntPtr exception);

        [DllImport("ArucoUnityPlugin")]
        private static extern void au_cv_imgproc_remap(IntPtr src, IntPtr dst, IntPtr map1, IntPtr map2,
            int interpolation,
            int borderType, IntPtr borderValue, IntPtr exception);

        [DllImport("ArucoUnityPlugin")]
        private static extern void au_cv_imgproc_undistort(IntPtr rotationVector, out IntPtr rotationMatrix,
            IntPtr cameraMatrix,
        ...
        public static void InitUndistortRectifyMap(Mat cameraMatrix, Mat distCoeffs, Mat R, Mat newCameraMatrix,
            Size size, Type m1type, out Mat map1,
            out Mat map2)
        {
            var exception = new Exception();
            IntPtr map1Ptr, map2Ptr;

            au_cv_imgproc_initUndistortRectifyMap(cameraMatrix.CppPtr, distCoeffs.CppPtr, R.CppPtr,
                newCameraMatrix.CppPtr, size.CppPtr, (int) m1type,
            ...
            Mat newCameraMatrix)
        {
            ...
            au_cv_imgproc_undistort(inputImage.CppPtr, out outputImagePtr, cameraMatrix.CppPtr, distCoeffs.CppPtr,
                newCameraMatrix.CppPtr,
                exception.CppPtr);
