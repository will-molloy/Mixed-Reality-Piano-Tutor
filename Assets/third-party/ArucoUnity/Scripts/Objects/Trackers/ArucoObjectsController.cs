  ...
  public abstract class ArucoObjectsController : ArucoObjectDetector, IArucoObjectsController
    {
        ...
        [SerializeField] [Tooltip("The list of the ArUco objects to detect.")]
        ...
        public virtual void AddArucoObject(ArucoObject arucoObject)
        {
            ...
            foreach (var arucoObjectDictionary in ArucoObjects)
                if (arucoObjectDictionary.Key.Name == arucoObject.Dictionary.Name ||
                    arucoObjectDictionary.Key == arucoObject.Dictionary)
                {
            ...
            {
                if (arucoObjectsCollection.ContainsKey(arucoObject.ArucoHashCode)) return;
            }
        ...
        public virtual HashSet<U> GetArucoObjects<U>(Aruco.Dictionary dictionary) where U : ArucoObject
        {
            ...
            var arucoTObjectsCollection = new HashSet<U>();
            foreach (var arucoObject in ArucoObjects[dictionary])
            {
                var arucoTObject = arucoObject.Value as U;
                if (arucoTObject != null) arucoTObjectsCollection.Add(arucoTObject);
            }
      ...
      /// <summary>
      ///     Adds to the <see cref="ArucoObjects" /> list the ArUco objects added from the editor field array
      ///     <see cref="arucoObjects" />.
      /// </summary>
      protected override void Start()
        {
            foreach (var arucoObject in arucoObjects) AddArucoObject(arucoObject);
            base.Start();
        }
