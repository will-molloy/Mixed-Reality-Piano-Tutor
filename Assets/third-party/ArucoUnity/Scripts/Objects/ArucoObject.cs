...
namespace ArucoUnity.Objects
{
  ...
  [ExecuteInEditMode]
    public abstract class ArucoObject : MonoBehaviour
    {
        ...
        [SerializeField] [Tooltip("The dictionary to use.")]
        private Aruco.PredefinedDictionaryName dictionaryName;

        [SerializeField] [Tooltip("Number of bits in marker borders (default: 1). Used by Creators.")]
      ...
      protected virtual void Awake()
        {
            if (Dictionary == null) dictionary = Aruco.GetPredefinedDictionary(dictionaryName);
            UpdateProperties();
        }
      ...
      /// <summary>
      ///     Returns the image of the ArUco object. In editor it should returns null and no exception if the object is
