...
namespace ArucoUnity.Objects.Displayers
{
    ...
    public class ArucoObjectDisplayer : MonoBehaviour
    {
        ...
        [SerializeField] [Tooltip("The ArUco object to display.")]
        private ArucoObject arucoObject;

        [SerializeField] [Tooltip("Display the image in play mode.")]
        private bool displayInPlayMode;
      ...
      protected ArucoObject ArucoObject
        {
            get { return arucoObject; }
            set { SetArucoObject(value); }
        }

      /// <summary>
      ///     Gets or sets if <see cref="ImagePlane" /> is displayed in play mode.
      /// </summary>
      protected bool DisplayInPlayMode
        {
            get { return displayInPlayMode; }
            set { displayInPlayMode = value; }
        }
      ...
      protected virtual void Update()
        {
            ...
            if (!EditorApplication.isPlayingOrWillChangePlaymode)
            {
                ...
                if (ArucoObject != null && Image == null) UpdateImage();

                // Keep the image plane at the same position
                if (ImagePlane != null) PlaceImagePlane();
            }
#endif
        }
      ...
      protected virtual void OnDestroy()
        {
            if (ArucoObject != null) ArucoObject.PropertyUpdated -= ArucoObject_PropertyUpdated;
        }
      ...
      private void OnDisable()
        {
#if UNITY_EDITOR
            if (!EditorApplication.isPlayingOrWillChangePlaymode) ResetImage();
#endif
        }
      ...
      public virtual void CreateImage()
        {
            ...
            if (Image != null)
            {
                ...
                var verticalFlipCode = 0;
                var imageForTexture = Image.Clone();
                Cv.Flip(imageForTexture, imageForTexture, verticalFlipCode);

                // Load the image to the texture
                var markerDataSize = (int) (Image.ElemSize() * Image.Total());
      ...
      public virtual void ResetImage()
        {
            Image = null;
            ImageTexture = null;
            if (imagePlaneMaterial != null) imagePlaneMaterial.mainTexture = null;
            if (ImagePlane != null) ImagePlane.SetActive(false);
        }
