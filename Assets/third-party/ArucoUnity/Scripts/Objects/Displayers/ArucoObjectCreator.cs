...
namespace ArucoUnity.Objects.Displayers
{
  ...
  ///     See the OpenCV documentation for more information about the marker creation (second section of the following
  ///     tutorial):
  ...
  public class ArucoObjectCreator : ArucoObjectDisplayer
    {
        ...
        [SerializeField] [Tooltip("Set automatically the image filename based on the Aruco object's property values.")]
        private bool automaticFilename = true;

        // Editor fields

        [SerializeField] [Tooltip("Save the image in play mode.")]
        private bool autoSaveInPlayMode = true;

        [SerializeField] [Tooltip("The name of the image, without the extension (.png added automatically).")]
      ...
      public bool AutoSaveImage
        {
            get { return autoSaveInPlayMode; }
            set { autoSaveInPlayMode = value; }
        }
...
#if UNITY_EDITOR
            if (automaticFilename) ImageFilename = ArucoObject.GenerateName();
#endif
      ...
      public virtual void SaveImage()
        {
            ...
            var outputFolderPath = Path.Combine(Application.isEditor
            ...
            var imageFilePath = outputFolderPath + ImageFilename;
