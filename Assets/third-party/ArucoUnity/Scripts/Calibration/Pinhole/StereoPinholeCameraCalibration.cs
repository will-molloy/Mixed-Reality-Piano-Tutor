    ...
    public class StereoPinholeCameraCalibration : PinholeCameraCalibrationBase<StereoArucoCamera>
    {
        ...
        protected override void Calibrate(Std.VectorVectorPoint2f[] imagePoints, Std.VectorVectorPoint3f[] objectPoints)
        {
            ...
            for (var cameraId = 0; cameraId < ArucoCamera.CameraNumber; cameraId++)
            {
                ...
                cameraParameters.ReprojectionErrors[cameraId] = Cv.CalibrateCamera(objectPoints[cameraId],
                    imagePoints[cameraId],
                    ArucoCamera.Images[cameraId].Size, cameraParameters.CameraMatrices[cameraId],
            ...
            stereoCameraParameters.ReprojectionError = Cv.StereoCalibrate(objectPoints[cameraId1],
                imagePoints[cameraId1],
                imagePoints[cameraId2], cameraMatrix1, distCoeffs1, cameraMatrix2, distCoeffs2, imageSize,
                out rotationMatrix,
