  ...
  public class PinholeCameraCalibrationFlags : CalibrationFlagsGeneric<Cv.Calib>
    {
        ...
        private const float DefaultFixAspectRatio = 1f;

        [SerializeField] private bool fixAspectRatio;

        [SerializeField] private float fixAspectRatioValue = DefaultFixAspectRatio;

        [Header("Additional flags for stereo calibration")] [SerializeField]
        private bool fixFocalLength;

        [SerializeField] private bool fixIntrinsic = true;

        // Editor fields

        [SerializeField] [Tooltip("The principal point (cx, cy) is not changed during the calibration.")]
        private bool fixPrincipalPoint;

        [SerializeField] private bool fixS1_S2_S3_S4;

        [SerializeField] private bool fixTauxTauy;

        [SerializeField] private bool rationalModel;

        [SerializeField] private bool sameFocalLength;

        [SerializeField] private bool thinPrismModel;

        [SerializeField] private bool tiltedModel;

        [SerializeField] private bool zeroTangentialDistorsion;
