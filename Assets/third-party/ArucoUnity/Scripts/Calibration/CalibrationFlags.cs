  ...
  public abstract class CalibrationFlags : MonoBehaviour
    {
        [SerializeField]
        [Tooltip(
            "The corresponding radial distortion coefficient is not changed during the calibration. If useIntrinsicGuess" +
        ...
        [SerializeField]
        [Tooltip(
            "Use and optimize the initial values (fx, fy), (cx, cy) of the camera matrix during the calibration process.")]
        private bool useIntrinsicGuess;
      ...
      /// <summary>
      ///     Keeps the <see cref="FixKDistorsionCoefficients" /> array to its fixed length <see cref="FixKLength" /> in the
      ///     editor.
      /// </summary>
