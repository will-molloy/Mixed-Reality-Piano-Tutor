...
namespace ArucoUnity.Calibration
{
        ...
        where U : CalibrationFlags
    {
        ...
        [SerializeField] [Tooltip("The camera system to use.")]
        private T arucoCamera;

        [SerializeField] [Tooltip("The flags for the cameras calibration.")]
      ...
      protected override void Awake()
        {
            ...
            if (calibrationFlags != null) CalibrationFlags = calibrationFlags;
        }
    }
}