...
namespace ArucoUnity.Calibration.Omnidir
{
  ...
  public class OmnidirCameraCalibrationFlags : CalibrationFlagsGeneric<Cv.Omnidir.Calib>
    {
        [SerializeField] private bool fixCenter;

        [SerializeField] private bool fixGamma;

        [SerializeField] private bool[] fixP;
        // Editor fields

        [SerializeField] private bool fixSkew;

        [SerializeField] private bool fixXi;
        ...
        {
            get { return fixCenter; }
            set { fixCenter = value; }
        }

        protected override int FixKLength => 2;

        protected int FixPLength => 2;
        ...
        protected override void OnValidate()
        {
            ...
            if (fixP != null && fixP.Length != FixPLength) Array.Resize(ref fixP, FixPLength);
        }
    }
}