  ...
  public abstract class ArucoCameraUndistortion : ArucoCameraController, IArucoCameraUndistortion
    {
        ...
        [SerializeField] [Tooltip("The camera parameters associated with the ArucoCamera.")]
      ...
      protected override void Configuring()
        {
            ...
            if (CameraParameters == null)
                throw new ArgumentNullException("CameraParameters",
                    "This property needs to be set for the configuration.");
            if (CameraParameters.CameraNumber != ArucoCamera.CameraNumber)
                throw new Exception(
                    "The number of cameras in CameraParameters must be equal to the number of cameras in ArucoCamera");
      ...
      /// <summary>
      ///     Updates the undistortion thread with the <paramref name="images" /> and stops if there was an exception from this
      ///     thread.
      /// </summary>
      ...
      /// <summary>
      ///     Undistorts and rectifies the <paramref name="images" /> using <see cref="UndistortionRectificationMaps" /> on a
      ///     separate thread.
      /// </summary>
