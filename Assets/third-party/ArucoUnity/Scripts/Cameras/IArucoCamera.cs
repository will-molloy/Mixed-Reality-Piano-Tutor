  ...
  public interface IArucoCamera : IConfigurableController
    {
      ...
      /// <summary>
      ///     Gets the the current images manipulated by Unity. There are <see cref="CameraNumber" /> images: one for each
      ///     camera.
      /// </summary>
      Texture2D[] Textures { get; }

      /// <summary>
      ///     Gets or sets the current images manipulated by OpenCV. There are <see cref="CameraNumber" /> images: one for each
      ///     camera.
      /// </summary>
      Cv.Mat[] Images { get; }
