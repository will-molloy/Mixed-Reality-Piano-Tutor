...
namespace ArucoUnity.Cameras.Displays
{
        ...
        where U : ArucoCameraUndistortion
    {
        ...
        [SerializeField] [Tooltip("The camera to use.")]
        private T arucoCamera;

        [SerializeField] [Tooltip("The optional undistortion process associated with the ArucoCamera.")]
      ...
      protected override void Awake()
        {
            base.Awake();
            if (arucoCamera != null) ArucoCamera = arucoCamera;
            if (arucoCameraUndistortion != null) ArucoCameraUndistortion = arucoCameraUndistortion;
        }
    }
}