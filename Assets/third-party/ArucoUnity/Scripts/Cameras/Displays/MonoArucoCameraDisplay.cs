...
namespace ArucoUnity.Cameras.Displays
{
  ...
  public class MonoArucoCameraDisplay : ArucoCameraDisplayGeneric<ArucoCamera, ArucoCameraUndistortion>
    {
        [SerializeField] [Tooltip("The Unity virtual camera that will shoot the background.")]
        ...
        public override Camera[] Cameras
        {
            get { return cameras; }
            protected set { cameras = value; }
        }

        public override Camera[] BackgroundCameras
        {
            get { return backgroundCameras; }
            protected set { backgroundCameras = value; }
        }

        public override Renderer[] Backgrounds
        {
            get { return backgrounds; }
            protected set { backgrounds = value; }
        }
