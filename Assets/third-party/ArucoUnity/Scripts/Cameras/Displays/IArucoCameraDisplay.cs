...
{
  /// <summary>
  ///     Manages Unity virual cameras that shoot 3D content aligned with the <see cref="IArucoCamera.Images" /> displayed as
  ///     background. It
  ///     creates the augmented reality effect by aligning the images from the physical cameras and the
  ///     <see cref="Objects.ArucoObject" /> tracked by
  ...
  public interface IArucoCameraDisplay : IArucoCameraController
    {
      ...
      /// <summary>
      ///     Gets the backgrounds displaying the <see cref="IArucoCamera.Images" /> of the corresponding physical camera in
      ///     ArucoCamera.
      /// </summary>
