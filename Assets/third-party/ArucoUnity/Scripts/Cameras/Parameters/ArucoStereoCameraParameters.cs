...
namespace ArucoUnity.Cameras.Parameters
{
  ...
  [Serializable]
    public class StereoArucoCameraParameters
    {
      ...
      /// </summary>
      /// <remarks>
      ///     When <see cref="UpdateSerializedProperties" /> is called, it's copied to the
      ///     <see cref="RotationVectorValues" /> property.
      /// </remarks>
      [XmlIgnore]
        public Cv.Vec3d RotationVector { get; set; }

      /// <summary>
      ///     Gets or sets the rotation matrix values between the coordinate systems of the cameras. Equals to the
      ///     <see cref="RotationVector" />
      ...
      /// </summary>
      /// <remarks>
      ///     When <see cref="UpdateSerializedProperties" /> is called, it's copied to the <see cref="TranslationVectorValues" />
      ///     property.
      /// </remarks>
      [XmlIgnore]
      ...
      /// <summary>
      ///     Gets or sets the translation vector values between the coordinate systems of the cameras. Equals to the
      ///     <see cref="TranslationVector" />
      ///     content and automatically written when <see cref="ArucoCameraParameters.SaveToXmlFile(string)" /> is called.
      /// </summary>
      /// <remarks>This property is be public for the serialization.</remarks>
