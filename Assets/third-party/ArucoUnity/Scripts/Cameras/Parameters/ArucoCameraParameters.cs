...
namespace ArucoUnity.Cameras.Parameters
{
  ...
  [Serializable]
    public class ArucoCameraParameters
    {
      ...
      /// </summary>
      /// <param name="camerasNumber">
      ///     The number of camera in the camera system. Must be equal to the number of cameras of the related
      ///     <see cref="ArucoCamera" />.
      /// </param>
      ...
      /// </summary>
      /// <remarks>
      ///     When <see cref="SaveToXmlFile(string)" /> is called, it's serialized with the <see cref="CameraMatricesType" /> and
      ///     <see cref="CameraMatricesValues" /> properties.
      /// </remarks>
      [XmlIgnore]
        public Cv.Mat[] CameraMatrices { get; set; }

      /// <summary>
      ///     The camera matrix type of the calibration. Equals to <see cref="CameraMatrices.Type()" /> and automatically written
      ///     when
      ...
      /// <summary>
      ///     The camera matrix values of the calibration. Equals to the <see cref="CameraMatrices" /> content and automatically
      ///     written when
      ///     <see cref="SaveToXmlFile(string)" /> is called.
      /// </summary>
      /// <remarks>This property is be public for the serialization.</remarks>
      ...
      /// </summary>
      /// <remarks>
      ///     When <see cref="SaveToXmlFile(string)" /> is called, it's serialized with the <see cref="DistCoeffsType" /> and
      ///     <see cref="DistCoeffsValues" /> properties.
      /// </remarks>
      [XmlIgnore]
        public Cv.Mat[] DistCoeffs { get; set; }

      /// <summary>
      ///     The distorsition coefficients type of the calibration. Equals to <see cref="DistCoeffs.Type()" /> and automatically
      ///     written when
      ///     <see cref="SaveToXmlFile(string)" /> is called.
      /// </summary>
      /// <remarks>This property is be public for the serialization.</remarks>
      ...
      /// <summary>
      ///     The distorsition coefficients values of the calibration. Equals to the <see cref="DistCoeffs" /> content and
      ...
      /// </summary>
      /// <remarks>
      ///     When <see cref="SaveToXmlFile(string)" /> is called, it's serialized with the <see cref="OmnidirXisType" /> and
      ///     <see cref="OmnidirXisValues" /> properties.
      /// </remarks>
      [XmlIgnore]
      ...
      /// <summary>
      ///     The xi parameter values of the calibration. Equals to the <see cref="OmnidirXis" /> content and automatically
      ///     written when
      ///     <see cref="SaveToXmlFile(string)" /> is called.
      /// </summary>
      /// <remarks>This property is be public for the serialization.</remarks>
      ...
      public static ArucoCameraParameters LoadFromXmlFile(string cameraParametersFilePath)
        {
            ...
            try
            {
                ...
                var serializer = new XmlSerializer(typeof(ArucoCameraParameters));
                cameraParameters = serializer.Deserialize(reader) as ArucoCameraParameters;
            }
            catch (Exception ex)
            {
                throw new ArgumentException(
                    "Couldn't load the camera parameters file path '" + cameraParametersFilePath + ". ",
            ...
            cameraParameters.CameraMatrices = CreateProperty(cameraParameters.CameraMatricesType,
                cameraParameters.CameraMatricesValues);
            cameraParameters.DistCoeffs =
                CreateProperty(cameraParameters.DistCoeffsType, cameraParameters.DistCoeffsValues);
            cameraParameters.OmnidirXis =
                CreateProperty(cameraParameters.OmnidirXisType, cameraParameters.OmnidirXisValues);
      ...
      public void SaveToXmlFile(string cameraParametersFilePath)
        {
            ...
            if (StereoCameraParameters != null) StereoCameraParameters.UpdateSerializedProperties();
            ...
            {
                throw new ArgumentException(
                    "Couldn't save the camera parameters to the file path '" + cameraParametersFilePath + ".",
      ...
      internal static void UpdatePropertyValues(Cv.Mat[] property, double[][][] propertyValues)
        {
            ...
            for (var cameraId = 0; cameraId < cameraNumber; cameraId++)
            {
                propertyValues[cameraId] = new double[rows][];
                for (var i = 0; i < rows; i++)
                {
                    propertyValues[cameraId][i] = new double[cols];
                    for (var j = 0; j < cols; j++) propertyValues[cameraId][i][j] = property[cameraId].AtDouble(i, j);
                }
            }
        }
      ...
      internal static Cv.Mat[] CreateProperty(Cv.Type propertyType, double[][][] propertyValues)
        {
            var cameraNumber = propertyValues.Length;
