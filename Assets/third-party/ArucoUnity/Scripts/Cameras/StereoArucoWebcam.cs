  ...
  public class StereoArucoWebcam : StereoArucoCamera
    {
        ...
        [SerializeField] [Tooltip("The id of the first webcam to use.")]
        private int webcamId1;

        [SerializeField] [Tooltip("The id of the second webcam to use.")]
      ...
      /// </summary>
      public int WebcamId1
        {
            get { return webcamId1; }
            set { webcamId1 = value; }
        }
      ...
      /// </summary>
      public int WebcamId2
        {
            get { return webcamId2; }
            set { webcamId2 = value; }
        }
      ...
      protected override void Configuring()
        {
            ...
            WebcamController.Ids.AddRange(new[] {WebcamId1, WebcamId2});
      ...
      protected override bool UpdatingImages()
        {
            for (var cameraId = 0; cameraId < CameraNumber; cameraId++)
                Array.Copy(WebcamController.Textures2D[cameraId].GetRawTextureData(), NextImageDatas[cameraId],
                    ImageDataSizes[cameraId]);
            return true;
        }
      ...
      protected virtual void WebcamController_Started(WebcamController webcamController)
        {
            for (var cameraId = 0; cameraId < CameraNumber; cameraId++)
            {
                ...
                Textures[cameraId] =
                    new Texture2D(webcamTexture.width, webcamTexture.height, webcamTexture.format, false);
            }
