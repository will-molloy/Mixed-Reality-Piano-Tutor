  ...
  public abstract class ArucoCamera : ConfigurableController, IArucoCamera
    {
        ...
        protected Cv.Mat[] NextImages => imageBuffers[NextBuffer()];
        protected byte[][] NextImageDatas => imageDataBuffers[NextBuffer()];
        ...
        public Cv.Mat[] Images => imageBuffers[currentBuffer];
        public byte[][] ImageDatas => imageDataBuffers[currentBuffer];
      ...
      protected override void Configuring()
        {
            ...
            if (CameraNumber <= 0) throw new Exception("It must have at least one camera.");
