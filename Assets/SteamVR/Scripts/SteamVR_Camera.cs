...
public class SteamVR_Camera : MonoBehaviour
{
    ...
    public Transform offset // legacy
        => _head;
...
#if UNITY_EDITOR
    public bool isExpanded => head != null && transform.parent == head;
#endif
    ...
    public string baseName => name.EndsWith(eyeSuffix) ? name.Substring(0, name.Length - eyeSuffix.Length) : name;
