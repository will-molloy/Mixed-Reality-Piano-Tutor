...
public class SteamVR : IDisposable
{
    ...
    public float hmd_SecondsFromVsyncToPhotons =>
        GetFloatProperty(ETrackedDeviceProperty.Prop_SecondsFromVsyncToPhotons_Float);
    ...
    public string GetTrackedDeviceString(uint deviceId)
    {
        ...
        if (capacity > 1)
        {
            ...
            hmd.GetStringTrackedDeviceProperty(deviceId, ETrackedDeviceProperty.Prop_AttachedDeviceId_String, result,
                capacity, ref error);
