...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        public Transform GetAttachmentTransform(string attachmentPoint = "")
        {
            ...
            if (!string.IsNullOrEmpty(attachmentPoint)) attachmentTransform = transform.Find(attachmentPoint);
        ...
        {
            if (startingHandType == HandType.Left || startingHandType == HandType.Right) return startingHandType;

            if (startingHandType == HandType.Any && otherHand != null && otherHand.controller == null)
                return HandType.Right;

            if (controller == null || otherHand == null || otherHand.controller == null) return startingHandType;
        ...
        public void DetachObject(GameObject objectToDetach, bool restoreOriginalParent = true)
        {
            ...
            if (index != -1)
            {
                ...
                attachedObjects[index].attachedObject
                    .SendMessage("OnDetachedFromHand", this, SendMessageOptions.DontRequireReceiver);
        ...
        {
            if (controller != null) return transform.parent.TransformVector(controller.velocity);
        ...
        {
            if (controller != null) return transform.parent.TransformVector(controller.angularVelocity);
        ...
        private void Awake()
        {
            ...
            if (hoverSphereTransform == null) hoverSphereTransform = transform;
        ...
        private IEnumerator Start()
        {
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    {
                        if (vr.hmd.GetTrackedDeviceClass((uint) i) != ETrackedDeviceClass.Controller) continue;
        ...
        private void UpdateHovering()
        {
            ...
            var boxMult = Util.RemapNumberClamped(handDiff, 0.0f, 0.5f * flHoverRadiusScale, 5.0f, 1.0f) *
                          flHoverRadiusScale;
        ...
        private void Update()
        {
            ...
            if (attached) attached.SendMessage("HandAttachedUpdate", this, SendMessageOptions.DontRequireReceiver);
        ...
        private void LateUpdate()
        {
            ...
            if (controllerObject != null && attachedObjects.Count == 0) AttachObject(controllerObject);
        }
        ...
        private void OnDrawGizmos()
        {
            ...
            var sphereTransform = hoverSphereTransform ? hoverSphereTransform : transform;
        ...
        public bool GetStandardInteractionButtonDown()
        {
            ...
            if (controller != null) return controller.GetHairTriggerDown();
        ...
        public bool GetStandardInteractionButtonUp()
        {
            ...
            if (controller != null) return controller.GetHairTriggerUp();
        ...
        public bool GetStandardInteractionButton()
        {
            ...
            if (controller != null) return controller.GetHairTrigger();
        ...
        private void InitController(int index)
        {
            if (controller == null)
            {
                ...
                BroadcastMessage("OnHandInitialized", index,
